...
A Next.js-based frontend for Gaia Protocol, a blockchain-powered platform for transparent environmental impact tracking and community-driven action on Avalanche.

## 🌍 Overview

Gaia Protocol enables communities to create, participate in, and track environmental campaigns with full transparency through blockchain technology. Built on Avalanche C-Chain (Fuji Testnet), the platform features real-time impact tracking, volunteer recognition, and verifiable results.

## 🔌 Wallet Integration

Gaia Protocol uses **Core Wallet** (Avalanche's official wallet) exclusively for blockchain interactions:

- **Supported Wallet**: Core Wallet only
- **Network**: Avalanche Fuji Testnet (Chain ID: 43113)
- **Setup Guide**: See [CORE_WALLET_SETUP.md](../CORE_WALLET_SETUP.md)
- **Developer Guide**: See [WALLET_INTEGRATION.md](../WALLET_INTEGRATION.md)

### Quick Wallet Setup

1. Install [Core Wallet](https://core.app/)
2. Get testnet AVAX from [Avalanche Faucet](https://faucet.avax.network/)
3. Connect wallet in the application header
4. Start creating and joining campaigns!
...
- **Wallet**: Core Wallet integration with ethers.js v6
- **Styling**: Tailwind CSS v4 with Emerald Green theme
